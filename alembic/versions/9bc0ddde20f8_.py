...
Revision ID: 9bc0ddde20f8
Revises: 07618cca7754
Create Date: 2021-06-17 06:22:31.136212
...
revision = '9bc0ddde20f8'
down_revision = '07618cca7754'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('model', 'gflops',
               ...
               type_=sa.Float(precision=3),
               existing_nullable=True)
    op.alter_column('model', 'epochs',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=True)
    op.alter_column('model', 'number_of_parameters',
               existing_type=sa.INTEGER(),
               type_=sa.BigInteger(),
               existing_nullable=True)
